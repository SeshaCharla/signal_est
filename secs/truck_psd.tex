...
\begin{minipage}{0.3\textwidth}
       \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{./figs/bfr_smth/truck_psd/y1.png}
...
\begin{minipage}{0.3\textwidth}
       \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{./figs/bfr_smth/truck_psd/u1.png}
...
\begin{minipage}{0.3\textwidth}
       \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{./figs/bfr_smth/truck_psd/T.png}
...
\begin{minipage}{0.3\textwidth}
       \begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{./figs/bfr_smth/truck_psd/F.png}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=\textwidth]{./figs/bfr_smth/truck_psd/u2.png}
        \caption{PSD of $[NO_x]^{out}$}
\end{figure}
\end{minipage}
